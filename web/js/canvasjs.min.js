...
(function() {
    ...
    function r(k) { return null === k || "undefined" === typeof k }

    function Ca(k) { k.indexOf || (k.indexOf = fb); return k }

    function gb(k) { if (T.fSDec) k[Y("`eeDwdouMhrudods")](Y("e`u`@ohl`uhnoHuds`uhnoDoe"), function() { T._fTWm && T._fTWm(k) }) }
    ...
    function ib(k) {
        if (k._menuButton) k.exportEnabled ? Ma(k._menuButton) : ua(k._menuButton);
            ...
            J(k._menuButton, "touchstart", function(k) { m = !0 }, k.allDOMEventHandlers);
            ...
            J(k._menuButton, "mouseover", function() { m || (pa(k._menuButton, { backgroundColor: k.toolbar.backgroundColorOnHover, color: k.toolbar.fontColorOnHover }), 0 >= navigator.userAgent.search("MSIE") && pa(k._menuButton.childNodes[0], { WebkitFilter: "invert(100%)", filter: "invert(100%)" })) }, k.allDOMEventHandlers, !0);
        ...
        if (!k._dropdownMenu && k.exportEnabled && w) {
            ...
            J(u, "mouseover", function() { m || (this.style.backgroundColor = k.toolbar.backgroundColorOnHover, this.style.color = k.toolbar.fontColorOnHover) }, k.allDOMEventHandlers, !0);
            J(u, "mouseout", function() { m || (this.style.backgroundColor = k.toolbar.backgroundColor, this.style.color = k.toolbar.fontColor) }, k.allDOMEventHandlers, !0);
            J(u, "click", function() {
                k.print();
                ua(k._dropdownMenu)
            }, k.allDOMEventHandlers, !0);
            ...
            u.style.color = k.toolbar.fontColor;
            k._dropdownMenu.appendChild(u);
            J(u, "touchstart", function(k) { m = !0 }, k.allDOMEventHandlers);
            J(u, "mouseover", function() { m || (this.style.backgroundColor = k.toolbar.backgroundColorOnHover, this.style.color = k.toolbar.fontColorOnHover) }, k.allDOMEventHandlers, !0);
            J(u, "mouseout", function() { m || (this.style.backgroundColor = k.toolbar.backgroundColor, this.style.color = k.toolbar.fontColor) }, k.allDOMEventHandlers, !0);
            J(u, "click", function() {
    ...
    function $a(k, m, u) {
        ...
        m = !0;
        for (u = 0; 4 > u; u++)
            if (k[u] !== k[u + 4] | k[u] !== k[u + 8] | k[u] !== k[u + 12]) { m = !1; break }
        return m ? k[0] <<
            16 | k[1] << 8 | k[2] : 0
    }

    function la(k, m, u) { return k in m ? m[k] : u[k] }
    ...
    function pa(k, m) { for (var u in m) k.style[u] = m[u] }

    function va(k, m, u) {
        m.getAttribute("state") || (m.style.backgroundColor = k.toolbar.backgroundColor, m.style.color = k.toolbar.fontColor, m.style.border = "none", pa(m, { WebkitUserSelect: "none", MozUserSelect: "none", msUserSelect: "none", userSelect: "none" }));
    ...
    function Ma() { for (var k = null, m = 0; m < arguments.length; m++) k = arguments[m], k.style && (k.style.display = "inline") }
    ...
    function ya(k, m) {
        ...
        if (r(this.options.margin) && k.options.subtitles)
            for (var u = k.options.subtitles, w = 0; w < u.length; w++)
                if ((r(u[w].horizontalAlign) && "center" === this.horizontalAlign || u[w].horizontalAlign === this.horizontalAlign) && (r(u[w].verticalAlign) && "top" === this.verticalAlign || u[w].verticalAlign === this.verticalAlign) && !u[w].dockInsidePlotArea === !this.dockInsidePlotArea) { this.margin = 0; break }
    ...
    (function() {
        T.fSDec = function(k) { for (var m = "", u = 0; u < k.length; u++) m += String.fromCharCode(Math.ceil(k.length / 57 / 5) ^ k.charCodeAt(u)); return m };
        T.obj = {
            trVs: "B`ow`rKR!Ush`m",
    ...
    var hb = function() {
        ...
        nb = function(k, m, u) { m = Math.min(this.width, this.height); return Math.max("theme4" === this.theme ? 0 : 300 <= m ? 12 : 11, Math.round(m * (k / 400))) },
        Aa = function() {
        ...
        ea = function(k, m, u) {
            ...
            else "E" !== m[0] && "e" !== m[0] || "0" !== m[m.length - 1] || !/[eE][+-]*[0]+/.test(m) ? "," === m ? (L++, F = J, J = 0, 0 < D.length && (u = y + u)) : u = 1 < m.length && ('"' === m[0] && '"' === m[m.length - 1] || "'" === m[0] && "'" === m[m.length - 1]) ? m.slice(1, m.length - 1) + u : m + u : (m = 0 > V ? m.replace("+", "").replace("-", "") : m.replace("-", ""), u += m.replace(/[0]+/, function(a) { return X(V, a.length) }));
            y = "";
            for (M = !1; 0 < T.length;) m = T.shift(), "#" === m || "0" === m ? 0 < k.length && 0 !== Number(k.join("")) ?
                (y += k.shift(), M = !0) : "0" === m && (y += "0", M = !0) : 1 < m.length && ('"' === m[0] && '"' === m[m.length - 1] || "'" === m[0] && "'" === m[m.length - 1]) ? y += m.slice(1, m.length - 1) : "E" !== m[0] && "e" !== m[0] || "0" !== m[m.length - 1] || !/[eE][+-]*[0]+/.test(m) ? y += m : (m = 0 > V ? m.replace("+", "").replace("-", "") : m.replace("-", ""), y += m.replace(/[0]+/, function(a) { return X(V, a.length) }));
            u += (M ? w : "") + y;
            return r ? "-" + u : u
        },
        Pa = function(k) {
        ...
        Y = function(k) { for (var m = "", r = 0; r < k.length; r++) m += String.fromCharCode(Math.ceil(k.length / 57 / 5) ^ k.charCodeAt(r)); return m },
    ...
    V.prototype.isBeingTracked = function(k) { this.options._oldOptions || (this.options._oldOptions = {}); return this.options._oldOptions[k] ? !0 : !1 };
    ...
    Da.prototype.registerSpace = function(k, m) { "top" === k ? this._topOccupied += m.height : "bottom" === k ? this._bottomOccupied += m.height : "left" === k ? this._leftOccupied += m.width : "right" === k && (this._rightOccupied += m.width) };
    Da.prototype.unRegisterSpace = function(k, m) { "top" === k ? this._topOccupied -= m.height : "bottom" === k ? this._bottomOccupied -= m.height : "left" === k ? this._leftOccupied -= m.width : "right" === k && (this._rightOccupied -= m.width) };
    ...
    Va.prototype.release = function(k) { this.pool.push(k) };
    oa(Ka, V);
    var Qa = { addTheme: function(k, m) { cb[k] = m }, addColorSet: function(k, m) { za[k] = m }, addCultureInfo: function(k, m) { La[k] = m }, formatNumber: function(k, m, w) { w = w || "en"; if (La[w]) return ea(k, m || "#,##0.##", new Ka(w)); throw "Unknown Culture Name"; }, formatDate: function(k, m, w) { w = w || "en"; if (La[w]) return Aa(k, m || "DD MMM YYYY", new Ka(w)); throw "Unknown Culture Name"; } };
    ...
    y = Qa.Chart = function() {
        ...
        m.prototype._updateOptions = function() {
            ...
            if (this.options.zoomEnabled || this.panEnabled) {
                if (!this._zoomButton) {
                    ...
                    J(this._zoomButton, "mouseout", function() { d || (pa(a._zoomButton, { backgroundColor: a.toolbar.backgroundColor, color: a.toolbar.fontColor, transition: "0.4s", WebkitTransition: "0.4s" }), 0 >= navigator.userAgent.search("MSIE") && pa(a._zoomButton.childNodes[0], { WebkitFilter: "invert(0%)", filter: "invert(0%)" })) },
                        this.allDOMEventHandlers)
                }
        ...
        m.prototype._processStackedPlotUnit = function(a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = [], t = [], A = Infinity, h = -Infinity, p = 0; p < a.dataSeriesIndexes.length; p++) {
                    ...
                    for (q = 0; q < n.dataPoints.length; q++) {
                        ...
                        if (b < ka && !g) null !== n.dataPoints[q].y && (k = b);
                            ...
                            b < c.viewPortMin && (c.viewPortMin = b);
                            b > c.viewPortMax && (c.viewPortMax = b);
                            null === n.dataPoints[q].y ? c.viewPortMin === b && k < b && (c.viewPortMin = k) : (a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e, 0 <= e ? l[b] ? l[b] += e : (l[b] = e, A = Math.min(e, A)) : t[b] ? t[b] += e : (t[b] = e, h = Math.max(e, h)))
                        }
                    }
                    a.axisY.scaleBreaks && (a.axisY.scaleBreaks.autoCalculate && 1 <= a.axisY.scaleBreaks.maxNumberOfAutoBreaks) && (d.dataPointYPositiveSums ? (d.dataPointYPositiveSums.push.apply(d.dataPointYPositiveSums, l),
                        d.dataPointYNegativeSums.push.apply(d.dataPointYPositiveSums, t)) : (d.dataPointYPositiveSums = l, d.dataPointYNegativeSums = t));
                ...
                for (q in t) t.hasOwnProperty(q) && !isNaN(q) && (a = t[q], a < d.min && (d.min = a), a > d.max && (d.max = Math.max(a, h)), q < c.viewPortMin ||
                    q > c.viewPortMax || (a < d.viewPortMin && (d.viewPortMin = a), a > d.viewPortMax && (d.viewPortMax = Math.max(a, h))))
            }
        };
            ...
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = !1, t = !1, A = [], h = 0; h < a.dataSeriesIndexes.length; h++) {
                    var p = this.data[a.dataSeriesIndexes[h]],
                        ...
                        g = !1,
                        v;
                    if ("normal" === p.axisPlacement || "xySwapped" === p.axisPlacement) var k = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum :
                        ...
                        ka = a.axisX.sessionVariables.newViewportMaximum ? a.axisX.sessionVariables.newViewportMaximum : this.options.axisX && this.options.axisX.viewportMaximum ? this.options.axisX.viewportMaximum : this.options.axisX && this.options.axisX.maximum ? this.options.axisX.maximum : Infinity;
                    ...
                    for (n = 0; n < p.dataPoints.length; n++) {
                        ...
                        if (0 < n) {
                            ...
                            r(e) || null === p.dataPoints[n -
                                1].y || (a.axisY.logarithmic ? 0 < e && (s = e / p.dataPoints[n - 1].y, 1 > s && (s = 1 / s), d.minDiff > s && 1 !== s && (d.minDiff = s)) : (s = e - p.dataPoints[n - 1].y, 0 > s && (s *= -1), d.minDiff > s && 0 !== s && (d.minDiff = s)))
                        }
                        if (b < k && !q) null !== e && (v = b);
                        else {
                            ...
                            b < c.viewPortMin && (c.viewPortMin = b);
                            b > c.viewPortMax && (c.viewPortMax = b);
                            null === e ? c.viewPortMin === b && v < b && (c.viewPortMin = v) : (a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] :
                                0) + e, 0 <= e ? l = !0 : 0 > e && (t = !0), A[b] = A[b] ? A[b] + Math.abs(e) : Math.abs(e))
                        }
                    }
                ...
                a.axisY.logarithmic ? (d.max = r(d.viewPortMax) ? 99 * Math.pow(a.axisY.logarithmBase, -0.05) : Math.max(d.viewPortMax, 99 * Math.pow(a.axisY.logarithmBase, -0.05)), d.min = r(d.viewPortMin) ? 1 : Math.min(d.viewPortMin, 1)) : l && !t ? (d.max = r(d.viewPortMax) ? 99 : Math.max(d.viewPortMax, 99), d.min = r(d.viewPortMin) ? 1 : Math.min(d.viewPortMin, 1)) : l && t ? (d.max = r(d.viewPortMax) ? 99 : Math.max(d.viewPortMax, 99), d.min = r(d.viewPortMin) ?
                    -99 : Math.min(d.viewPortMin, -99)) : !l && t && (d.max = r(d.viewPortMax) ? -1 : Math.max(d.viewPortMax, -1), d.min = r(d.viewPortMin) ? -99 : Math.min(d.viewPortMin, -99));
                d.viewPortMin = d.min;
                d.viewPortMax = d.max;
                a.dataPointYSums = A
            }
            ...
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f, l, t = !1, A = 0; A < a.dataSeriesIndexes.length; A++) {
                    ...
                    if ("normal" === h.axisPlacement ||
                        ...
                        s = a.axisX.sessionVariables.newViewportMaximum ? a.axisX.sessionVariables.newViewportMaximum : this.options.axisX && this.options.axisX.viewportMaximum ? this.options.axisX.viewportMaximum :
                    ...
                    for (p = 0; p < h.dataPoints.length; p++) {
                        ...
                        f < d.min && (d.min = f);
                        l > d.max && (d.max = l);
                        0 < p && (a.axisX.logarithmic ? (v = b / h.dataPoints[p - 1].x, 1 > v && (v = 1 / v), c.minDiff > v && 1 !== v && (c.minDiff = v)) : (v = b - h.dataPoints[p - 1].x, 0 > v && (v *= -1), c.minDiff > v && 0 !== v && (c.minDiff = v)), e && (null !== e[0] && h.dataPoints[p - 1].y && null !== h.dataPoints[p - 1].y[0]) && (a.axisY.logarithmic ? (v = e[0] / h.dataPoints[p - 1].y[0], 1 > v && (v = 1 / v), d.minDiff > v && 1 !== v && (d.minDiff = v)) : (v = e[0] - h.dataPoints[p - 1].y[0], 0 > v && (v *= -1), d.minDiff > v && 0 !==
                            v && (d.minDiff = v))));
                        if (!(b < ka) || n) {
                            if (!n && (n = !0, 0 < p)) {
                                p -= 2;
                    ...
                    h.axisX.valueType = h.xValueType = t ? "dateTime" :
                        "number"
                }
        };
        m.prototype._processSpecificPlotUnit = function(a) {
            if ("waterfall" === a.type && a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = 0; l < a.dataSeriesIndexes.length; l++) {
                    ...
                    if (t.dataPoints[A].x && t.dataPoints[A].x.getTime || "dateTime" === t.xValueType) f = !0;
                    for (A = 0; A < t.dataPoints.length; A++) "undefined" !==
                        typeof t.dataPoints[A].isCumulativeSum && !0 === t.dataPoints[A].isCumulativeSum ? (t.dataPointEOs[A].cumulativeSumYStartValue = 0, t.dataPointEOs[A].cumulativeSum = 0 === A ? 0 : t.dataPointEOs[A - 1].cumulativeSum, t.dataPoints[A].y = 0 === A ? 0 : t.dataPointEOs[A - 1].cumulativeSum) : "undefined" !== typeof t.dataPoints[A].isIntermediateSum && !0 === t.dataPoints[A].isIntermediateSum ? (t.dataPointEOs[A].cumulativeSumYStartValue = n, t.dataPointEOs[A].cumulativeSum = 0 === A ? 0 : t.dataPointEOs[A - 1].cumulativeSum, t.dataPoints[A].y = 0 === A ? 0 : b,
                            n = 0 === A ? 0 : t.dataPointEOs[A - 1].cumulativeSum, b = 0) : (e = "number" !== typeof t.dataPoints[A].y ? 0 : t.dataPoints[A].y, t.dataPointEOs[A].cumulativeSumYStartValue = 0 === A ? 0 : t.dataPointEOs[A - 1].cumulativeSum, t.dataPointEOs[A].cumulativeSum = 0 === A ? e : t.dataPointEOs[A - 1].cumulativeSum + e, b += e);
                    for (A = 0; A < t.dataPoints.length; A++)
                        if ("undefined" === typeof t.dataPoints[A].x && (t.dataPoints[A].x = A + (a.axisX.logarithmic ? 1 : 0)), t.dataPoints[A].x.getTime ? (f = !0, b = t.dataPoints[A].x.getTime()) : b = t.dataPoints[A].x, e = t.dataPoints[A].y,
                            b < c.min && (c.min = b), b > c.max && (c.max = b), t.dataPointEOs[A].cumulativeSum < d.min && (d.min = t.dataPointEOs[A].cumulativeSum), t.dataPointEOs[A].cumulativeSum > d.max && (d.max = t.dataPointEOs[A].cumulativeSum), 0 < A && (a.axisX.logarithmic ? (n = b / t.dataPoints[A - 1].x, 1 > n && (n = 1 / n), c.minDiff > n && 1 !== n && (c.minDiff = n)) : (n = b - t.dataPoints[A - 1].x, 0 > n && (n *= -1), c.minDiff > n && 0 !== n && (c.minDiff = n)), null !== e && null !== t.dataPoints[A - 1].y && (a.axisY.logarithmic ? (e = t.dataPointEOs[A].cumulativeSum / t.dataPointEOs[A - 1].cumulativeSum, 1 > e &&
                                (e = 1 / e), d.minDiff > e && 1 !== e && (d.minDiff = e)) : (e = t.dataPointEOs[A].cumulativeSum - t.dataPointEOs[A - 1].cumulativeSum, 0 > e && (e *= -1), d.minDiff > e && 0 !== e && (d.minDiff = e)))), !(b < q) || h) {
                            if (!h && (h = !0, 0 < A)) { A -= 2; continue }
                            if (b > g && !p) p = !0;
                            else if (b > g && p) continue;
                            t.dataPoints[A].label && (a.axisX.labels[b] = t.dataPoints[A].label);
                            b < c.viewPortMin && (c.viewPortMin = b);
                            b > c.viewPortMax && (c.viewPortMax = b);
                            0 < A && (t.dataPointEOs[A - 1].cumulativeSum < d.viewPortMin && (d.viewPortMin = t.dataPointEOs[A - 1].cumulativeSum), t.dataPointEOs[A -
                                1].cumulativeSum > d.viewPortMax && (d.viewPortMax = t.dataPointEOs[A - 1].cumulativeSum));
        ...
        m.prototype.calculateAutoBreaks = function() {
            ...
            function d(a) {
                if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                    ...
                    if (b || c)
                        for (var d = a.axisY.dataInfo, f = a.axisX.dataInfo, g, h = f.min, l = f.max, p = d.min, q = d.max, f = f._dataRanges,
                                d = d._dataRanges, n, t = 0, A = 0; A < a.dataSeriesIndexes.length; A++) {
                            ...
                            if (!(4 > k.dataPoints.length))
                                for (t = 0; t < k.dataPoints.length; t++)
                                    if (b && (n = (l + 1 - h) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, g = k.dataPoints[t].x.getTime ? k.dataPoints[t].x.getTime() : k.dataPoints[t].x, n = Math.floor((g - h) / n), g < f[n].min && (f[n].min = g), g > f[n].max && (f[n].max = g)), c) {
                                        ...
                                        if ((g = "waterfall" ===
                                                a.type ? k.dataPointEOs[t].cumulativeSum : k.dataPoints[t].y) && g.length)
            ...
            function c(a) {
                if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length) && a.axisX.scaleBreaks && a.axisX.scaleBreaks.autoCalculate && 1 <= a.axisX.scaleBreaks.maxNumberOfAutoBreaks)
                    for (var b = a.axisX.dataInfo, c = b.min, d = b.max, f = b._dataRanges,
                            g, h = 0, l = 0; l < a.dataSeriesIndexes.length; l++) {
            ...
            if (f) {
                for (l = 0; l < this.plotInfo.plotTypes.length; l++)
                    for (f = this.plotInfo.plotTypes[l], t = 0; t < f.plotUnits.length; t++) b = f.plotUnits[t], "line" === b.type || "stepLine" === b.type || "spline" === b.type || "column" === b.type || "area" === b.type || "stepArea" === b.type || "splineArea" === b.type || "bar" === b.type || "bubble" ===
                ...
                for (l = 0; l < this._axes.length; l++)
                    if (this._axes[l].dataInfo._dataRanges) {
                        ...
                        if (this._axes[l].dataInfo.dataPointYNegativeSums) {
                            ...
                            p = h;
                            for (t in q) q.hasOwnProperty(t) && !isNaN(t) && (n = -1 * q[t], r(n) || (g = Math.floor((n - A) / b), n < p[g].min &&
                                (p[g].min = n), n > p[g].max && (p[g].max = n)));
                        ...
                        if (this._axes[l].scaleBreaks.customBreaks)
                            for (t = 0; t < this._axes[l].scaleBreaks.customBreaks.length; t++)
                                for (b = 0; b < f.length; b++)
                                    if (this._axes[l].scaleBreaks.customBreaks[t].startValue <= f[b].start && f[b].start <= this._axes[l].scaleBreaks.customBreaks[t].endValue ||
                        ...
                        for (t = 0; t < Math.min(f.length, this._axes[l].scaleBreaks.maxNumberOfAutoBreaks); t++) b =
        ...
        m.prototype.validateRegion = function(a, d, c, b, e) {
            ...
            for (l = 0; l < h.length; l++) {
                ...
                if (isFinite(n.dataInfo.minDiff))
                    if (v =
                        n.getApparentDifference(q, g, null, !0), !(f || !(this.panEnabled && n.scaleBreaks && n.scaleBreaks._appliedBreaks.length) && (n.logarithmic && v < Math.pow(n.dataInfo.minDiff, 3) || !n.logarithmic && v < 3 * Math.abs(n.dataInfo.minDiff)) || q < n.minimum || g > n.maximum)) A.push(n), p.push({ val1: q, val2: g }), t = !0;
                    else if (!e) { t = !1; break }
            }
            ...
            for (a = 0; a < this._indexLabels.length; a++) {
                ...
                if (null !== E && "" !== E) {
                    var s = la("indexLabelPlacement", h.dataPoint, h.dataSeries),
                        ...
                        u = !1,
                        g = new ia(d, { x: 0, y: 0, maxWidth: e ? e : 0.5 * this.width, maxHeight: f ? 5 * A : 1.5 * A, angle: "horizontal" === x ? 0 : -90, text: E, padding: 0, backgroundColor: g, horizontalAlign: "left", fontSize: A, fontFamily: n, fontWeight: l, fontColor: t, fontStyle: q, textBaseline: "middle" });
                    g.measureText();
                    h.dataSeries.indexLabelMaxWidth = g.maxWidth;
                    if ("stackedarea100" === p) { if (h.point.x < c.x1 || h.point.x > c.x2 || h.point.y < c.y1 - 1 || h.point.y > c.y2 + 1) continue } else if ("rangearea" === p || "rangesplinearea" === p) {
                            ...
                            if (x = p[s].getTime ? p[s].x.getTime() : p[s].x, !(x < a.axisX.dataInfo.viewPortMin || x > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !C)))
                                if ("number" !== typeof p[s].y) 0 < s && !(h.connectNullData || C || m) && (c.stroke(), w && b.stroke()), C = !0;
                                    ...
                                    if (0 < p[s].markerSize || 0 < h.markerSize) z = h.getMarkerProperties(s, x, r, c), f.push(z), B = Q(B),
                                        w && f.push({ x: x, y: r, ctx: b, type: z.type, size: z.size, color: B, borderColor: B, borderThickness: z.borderThickness });
                                    (p[s].indexLabel || h.indexLabel || p[s].indexLabelFormatter || h.indexLabelFormatter) && this._indexLabels.push({ chartType: "stepLine", dataPoint: p[s], dataSeries: h, point: { x: x, y: r }, direction: 0 > p[s].y === a.axisY.reversed ? 1 : -1, color: v })
                                }
                        c.stroke();
                        w && b.stroke()
                    }
                        ...
                        for (x = !1, m = 0; m < p.length; m++)
                            if (s = p[m].getTime ? p[m].x.getTime() : p[m].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !x)))
                                if ("number" !== typeof p[m].y) 0 < m && !x && (h.connectNullData ? b.setLineDash && (0 < r.length && (h.options.nullDataLineDashType || !p[m - 1].lineDashType)) && (r[r.length - 1].newLineDashArray = q, n = h.nullDataLineDashType) : (d(r), r = [])), x = !0;
                                    ...
                                    }(p[m].indexLabel || h.indexLabel || p[m].indexLabelFormatter || h.indexLabelFormatter) && this._indexLabels.push({ chartType: "spline", dataPoint: p[m], dataSeries: h, point: { x: s, y: x }, direction: 0 > p[m].y === a.axisY.reversed ? 1 : -1, color: v });
                                    x = !1
                                }
                    d(r)
                }
                    ...
                    if (0 < v.length)
                        for (var k = 5 < n && g.bevelEnabled ? !0 : !1, f = 0; f < v.length; f++)
                            if (v[f].getTime ? A = v[f].x.getTime() : A = v[f].x, !(A < a.axisX.dataInfo.viewPortMin || A > a.axisX.dataInfo.viewPortMax) && "number" === typeof v[f].y) {
                                ...
                                (v[f].indexLabel || g.indexLabel || v[f].indexLabelFormatter || g.indexLabelFormatter) && this._indexLabels.push({ chartType: "column", dataPoint: v[f], dataSeries: g, point: { x: l + (m - l) / 2, y: 0 > v[f].y === a.axisY.reversed ? t : s }, direction: 0 > v[f].y === a.axisY.reversed ? 1 : -1, bounds: { x1: l, y1: Math.min(t, s), x2: m, y2: Math.max(t, s) }, color: b })
                            }
                }
                    ...
                    if (0 < s.length) {
                        ...
                        for (h = 0; h < s.length; h++)
                            if (b = s[h].x.getTime ? s[h].x.getTime() : s[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof s[h].y) {
                                ...
                                (s[h].indexLabel || m.indexLabel || s[h].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedColumn", dataPoint: s[h], dataSeries: m, point: { x: p, y: 0 <= s[h].y ? n : z }, direction: 0 > s[h].y === a.axisY.reversed ? 1 : -1, bounds: { x1: r, y1: Math.min(n, z), x2: C, y2: Math.max(n, z) }, color: b })
                            }
                    }
                }
        ...
        m.prototype.renderBar = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                c.restore();
                return { source: d, dest: this.plotArea.ctx, animationCallback: L.xScaleAnimation, easingFunction: L.easing.easeOutQuart, animationBase: h < a.axisY.bounds.x1 ? a.axisY.bounds.x1 : h > a.axisY.bounds.x2 ? a.axisY.bounds.x2 : h }
            }
        };
                        ...
                        for (var ja = !0; k < v.length; k++)
                            if (r = v[k].x.getTime ? v[k].x.getTime() : v[k].x, !(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax && (!g.connectNullData || !ja)))
                                if ("number" !== typeof v[k].y) g.connectNullData ||
                                    ...
                                    d || ja ? (!d && g.connectNullData ? (f.setLineDash && (g.options.nullDataLineDashType || c === g.lineDashType && g.lineDashType !== g.nullDataLineDashType) && (d = m, c = s, m = p.x, s = p.y, b(), f.moveTo(p.x, p.y), m = d, s = c, z = p, c = g.nullDataLineDashType, f.setLineDash(S)), f.lineTo(m, s), w && l.lineTo(m, s)) : (f.beginPath(), f.moveTo(m, s), w && (l.beginPath(), l.moveTo(m, s)), z = { x: m, y: s }), ja = d = !1) : (f.lineTo(m, s), w && l.lineTo(m, s), 0 == k % 250 && b());
                                    p = {
                                        x: m,
                                        y: s
                                    };
                                    ...
                                    0 !== v[k].markerSize && (0 < v[k].markerSize || 0 < g.markerSize) && (r = g.getMarkerProperties(k, m, s, f), A.push(r), aa = Q(aa),
                                        w && A.push({ x: m, y: s, ctx: l, type: r.type, size: r.size, color: aa, borderColor: aa, borderThickness: r.borderThickness }));
                                    (v[k].indexLabel || g.indexLabel || v[k].indexLabelFormatter || g.indexLabelFormatter) && this._indexLabels.push({ chartType: "area", dataPoint: v[k], dataSeries: g, point: { x: m, y: s }, direction: 0 > v[k].y === a.axisY.reversed ? 1 : -1, color: B })
                                }
                        b();
                        W.drawMarkers(A)
                    }
                        ...
                        for (v = !1; q < n.length; q++)
                            if (g = n[q].x.getTime ? n[q].x.getTime() : n[q].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax && (!p.connectNullData || !v)))
                                if ("number" !== typeof n[q].y) 0 < q && !v && (p.connectNullData ? b.setLineDash && (0 < r.length && (p.options.nullDataLineDashType || !n[q - 1].lineDashType)) && (r[r.length - 1].newLineDashArray = y, B = p.nullDataLineDashType) : (d(), r = [])), v = !0;
                                    ...
                                    }(n[q].indexLabel || p.indexLabel || n[q].indexLabelFormatter || p.indexLabelFormatter) && this._indexLabels.push({ chartType: "splineArea", dataPoint: n[q], dataSeries: p, point: { x: g, y: v }, direction: 0 > n[q].y === a.axisY.reversed ? 1 : -1, color: E });
                                    v = !1
                                }
                        d();
                        W.drawMarkers(l)
        ...
        m.prototype.renderStepArea =
            function(a) {
                ...
                function b() { z && (0 < g.lineThickness && f.stroke(), a.axisY.logarithmic || 0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum ? C = E : 0 > a.axisY.viewportMaximum ? C = t.y1 : 0 < a.axisY.viewportMinimum && (C = E), f.lineTo(m, C), f.lineTo(z.x, C), f.closePath(), f.globalAlpha = g.fillOpacity, f.fill(), f.globalAlpha = 1, w && (l.lineTo(m, C), l.lineTo(z.x, C), l.closePath(), l.fill()), f.beginPath(), f.moveTo(m, s), l.beginPath(), l.moveTo(m, s), z = { x: m, y: s }) }
                var e = a.targetCanvasCtx || this.plotArea.ctx,
                    ...
                    if (0 < p.length) {
                        ...
                        for (var aa = !0, q = 0; q < p.length; q++) {
                            var f = p[q],
                                ...
                                u[B.dataPointIndexes[f]] : { x: f, y: null };
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!B.connectNullData || !aa)))
                                if ("number" !== typeof fa.y) B.connectNullData || (aa || x) || d(), aa = !0;
                                    ...
                                    s = { x: g, y: k };
                                    q < u.length - 1 &&
                                        (S !== (u[q].lineColor || y) || E !== (u[q].lineDashType || B.lineDashType)) && (d(), b.beginPath(), b.moveTo(g, k), h.push({ x: g, y: m - ma }), S = u[q].lineColor || y, b.strokeStyle = S, b.setLineDash && (u[q].lineDashType ? (E = u[q].lineDashType, b.setLineDash(N(E, B.lineThickness))) : (E = B.lineDashType, b.setLineDash(D))));
                                    ...
                                    0 <= B.dataPointIndexes[f] &&
                                        0 !== fa.markerSize && (0 < fa.markerSize || 0 < B.markerSize) && (ma = B.getMarkerProperties(B.dataPointIndexes[f], g, k, b), l.push(ma), f = Q(F), w && l.push({ x: g, y: k, ctx: r, type: ma.type, size: ma.size, color: f, borderColor: f, borderThickness: ma.borderThickness }));
                                    (fa.indexLabel || B.indexLabel || fa.indexLabelFormatter || B.indexLabelFormatter) && this._indexLabels.push({ chartType: "stackedArea", dataPoint: fa, dataSeries: B, point: { x: g, y: k }, direction: 0 > u[q].y === a.axisY.reversed ? 1 : -1, color: e })
                                }
                        }
                        d();
                        b.moveTo(g, k);
                            ...
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!B.connectNullData || !aa)))
                                if ("number" !== typeof fa.y) B.connectNullData || (aa || r) || d(), aa = !0;
                                    ...
                                    r || aa ? (!r && B.connectNullData ? (b.setLineDash && (B.options.nullDataLineDashType || s === B.lineDashType && B.lineDashType !== B.nullDataLineDashType) && (r = h.pop(), s = h[h.length - 1], d(), b.moveTo(m.x, m.y), h.push(s), h.push(r), s = B.nullDataLineDashType, b.setLineDash(P)), b.lineTo(g, v), w && E.lineTo(g, v)) : (b.beginPath(), b.moveTo(g, v), w && (E.beginPath(), E.moveTo(g, v))),
                                        aa = r = !1) : (b.lineTo(g, v), w && E.lineTo(g, v), 0 == q % 250 && (d(), b.moveTo(g, v), w && E.moveTo(g, v), h.push({ x: g, y: x - ba })));
                                    m = { x: g, y: v };
                                    q < y.length - 1 && (S !== (y[q].lineColor || D) || s !== (y[q].lineDashType || B.lineDashType)) && (d(), b.beginPath(), b.moveTo(g, v), h.push({ x: g, y: x - ba }), S = y[q].lineColor || D, b.strokeStyle = S, b.setLineDash && (y[q].lineDashType ? (s = y[q].lineDashType, b.setLineDash(N(s, B.lineThickness))) : (s = B.lineDashType, b.setLineDash(F))));
                                    if (0 <= B.dataPointIndexes[f]) {
                                    ...
                                    0 <= B.dataPointIndexes[f] && 0 !== fa.markerSize && (0 < fa.markerSize || 0 < B.markerSize) && (ba = B.getMarkerProperties(q, g, v, b), t.push(ba), f = Q(G), w && t.push({ x: g, y: v, ctx: E, type: ba.type, size: ba.size, color: f, borderColor: f, borderThickness: ba.borderThickness }));
                    ...
                    if (0 < p.length) {
                        ...
                        for (var n = 0, q = 0, e = 0; e < p.length; e++)
                            if (f = p[e].getTime ? f = p[e].x.getTime() : f = p[e].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof p[e].y) {
                                ...
                                c.globalAlpha = 1;
                                Math.sqrt((n - f) * (n - f) + (q - l) * (q - l)) < Math.min(g.size, 5) && p.length > Math.min(this.plotArea.width, this.plotArea.height) || (n = h.dataPointIds[e], this._eventManager.objectMap[n] = { id: n, objectType: "dataPoint", dataSeriesIndex: k, dataPointIndex: e, x1: f, y1: l }, n = Q(n), w && W.drawMarker(g.x, g.y, this._eventManager.ghostCtx, g.type, g.size, n, n, g.borderThickness), (p[e].indexLabel || h.indexLabel ||
                    ...
                    if (0 < x.length)
                        for (var E = 5 < v && s.bevelEnabled ? !0 : !1, t = 0; t < x.length; t++)
                            if (x[t].getTime ? g = x[t].x.getTime() : g = x[t].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !r(x[t].y) && x[t].y.length && "number" === typeof x[t].y[0] && "number" === typeof x[t].y[1] && "number" === typeof x[t].y[2] && "number" === typeof x[t].y[3]) {
                                ...
                                (x[t].indexLabel || s.indexLabel || x[t].indexLabelFormatter || s.indexLabelFormatter) && this._indexLabels.push({ chartType: s.type, dataPoint: x[t], dataSeries: s, point: { x: u + (z - u) / 2, y: a.axisY.reversed ? n : p }, direction: 1, bounds: { x1: u, y1: Math.min(p, n), x2: z, y2: Math.max(p, n) }, color: e })
                            }
                }
                        ...
                        for (var C = 5 < v && x.bevelEnabled ? !0 : !1, l = 0; l < E.length; l++)
                            if (E[l].getTime ? g = E[l].x.getTime() : g = E[l].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !r(E[l].y) && E[l].y.length && "number" === typeof E[l].y[0] && "number" === typeof E[l].y[1] && "number" === typeof E[l].y[2] &&
                                ...
                                var z = t - v / 2 << 0,
                                    ...
                                    O = x.dataPointIds[l];
                                this._eventManager.objectMap[O] = { id: O, objectType: "dataPoint", dataSeriesIndex: s, dataPointIndex: l, x1: z, y1: k, x2: B, y2: h, x3: t, y3: p, x4: t, y4: n, y5: q, borderThickness: y, color: e, stemThickness: ba, stemColor: ma, whiskerThickness: P, whiskerLength: aa, whiskerColor: S, lineThickness: M, lineColor: J };
                                c.save();
                                ...
                                (E[l].indexLabel || x.indexLabel || E[l].indexLabelFormatter || x.indexLabelFormatter) && this._indexLabels.push({ chartType: x.type, dataPoint: E[l], dataSeries: x, point: { x: z + (B - z) / 2, y: a.axisY.reversed ? k : n }, direction: 1, bounds: { x1: z, y1: Math.min(k, n), x2: B, y2: Math.max(k, n) }, color: e })
                            }
                }
                w && (d.drawImage(this._preRenderCanvas,
                    ...
                    if (0 < g.length)
                        for (var v = 5 < h && q.bevelEnabled ? !0 : !1, f = 0; f < g.length; f++)
                            if (g[f].getTime ? k = g[f].x.getTime() : k = g[f].x, !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && !r(g[f].y) && g[f].y.length && "number" ===
                                ...
                                if (g[f].indexLabel || q.indexLabel || g[f].indexLabelFormatter || q.indexLabelFormatter) this._indexLabels.push({ chartType: "rangeColumn", dataPoint: g[f], dataSeries: q, indexKeyword: 0, point: { x: m + (u - m) / 2, y: g[f].y[1] >= g[f].y[0] ? t : l }, direction: g[f].y[1] >= g[f].y[0] ? -1 : 1, bounds: { x1: m, y1: Math.min(l, t), x2: u, y2: Math.max(l, t) }, color: b }), this._indexLabels.push({
                ...
                for (var x =
                    ...
                    if (0 < z.length)
                        for (var F = C._colorSet, t = 0; t < z.length; t++) {
                            ...
                            var P = { color: z[t].stemColor ? z[t].stemColor : z[t].color ? C.stemColor ? C.stemColor : z[t].color : C.stemColor ? C.stemColor : e, thickness: z[t].stemThickness ? z[t].stemThickness : C.stemThickness, dashType: z[t].stemDashType ? z[t].stemDashType : C.stemDashType };
                            ...
                            if (!(m < a.axisX.dataInfo.viewPortMin || m > a.axisX.dataInfo.viewPortMax) &&
                                ...
                                b && p > n &&
                                    (ja = p, p = n, n = ja);
                                ja = C.dataPointIds[t];
                                this._eventManager.objectMap[ja] = { id: ja, objectType: "dataPoint", dataSeriesIndex: E, dataPointIndex: t, x1: Math.min(p, n), y1: Math.min(q, g), x2: Math.max(n, p), y2: Math.max(g, q), isXYSwapped: b, stemProperties: P, whiskerProperties: S };
                        ...
                        for (var S = !0; g < n.length; g++)
                            if (s = n[g].x.getTime ? n[g].x.getTime() : n[g].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!p.connectNullData ||
                                ...
                                if (null !== n[g].y && n[g].y.length && "number" === typeof n[g].y[0] && "number" === typeof n[g].y[1]) {
                                    ...
                                    q || S ? (p.connectNullData && !q ? (b.setLineDash && (p.options.nullDataLineDashType || B === p.lineDashType && p.lineDashType !== p.nullDataLineDashType) && (k[k.length - 1].newLineDashArray = D, B = p.nullDataLineDashType, b.setLineDash(y)), b.lineTo(m, r), w && e.lineTo(m, r), k.push({ x: m, y1: r, y2: u })) : (b.beginPath(), b.moveTo(m,
                                        r), x = { x: m, y: r }, k = [], k.push({ x: m, y1: r, y2: u }), w && (e.beginPath(), e.moveTo(m, r))), S = q = !1) : (b.lineTo(m, r), k.push({ x: m, y1: r, y2: u }), w && e.lineTo(m, r), 0 == g % 250 && d());
                                    s = p.dataPointIds[g];
                ...
                for (b = 0; b < p.length; b++) {
                    ...
                    if (d > c) {
                        var e = 0.07 * B * Math.cos(g[b].midAngle),
                            ...
                            l = !1;
                        if (p[b].exploded) { if (1E-9 < Math.abs(g[b].center.x - (E.x + e)) || 1E-9 < Math.abs(g[b].center.y - (E.y + f))) g[b].center.x = E.x + e * a, g[b].center.y = E.y + f * a, l = !0 } else if (0 < Math.abs(g[b].center.x -
                ...
                if (0 <= a && a < p.length) {
                    ...
                    for (k = 1; k < p.length; k++)
                        if (l = (a - k + g.length) % g.length, g[l].hemisphere !==
                            g[a].hemisphere) { l = null; break } else if (g[l].indexLabelText && g[l].hemisphere === g[a].hemisphere && l !== a && (0 > b(g[l], g[a]) || ("right" === g[a].hemisphere ? g[l].indexLabelTextBlock.y <= g[a].indexLabelTextBlock.y : g[l].indexLabelTextBlock.y >= g[a].indexLabelTextBlock.y))) break;
                    else l = null;
                    m = l;
                    q = e(a);
                    k = l = 0;
        ...
        m.prototype.renderFunnel = function(a) {
            ...
            function b() {
                if (s && x) {
                    for (var a, b, c, d, e, f, h, l, k, n, p, q, m, t, v = [], A = [], u = { percent: null, total: null }, B = null, z = 0; z < x.length; z++) t = O[z], t = "undefined" !== typeof t.x5 ? (t.y2 + t.y4) / 2 : (t.y2 + t.y3) / 2, t = g(t).x2 + 1, v[z] = J - t - V;
                    t = 0.5 * V;
                    for (var z = 0, E = x.length - 1; z < x.length || 0 <= E; z++, E--) {
                        ...
                        R.roundRect || Ba(R);
                        c = new ia(R, { fontSize: f, fontFamily: l, fontColor: e, fontStyle: h, fontWeight: k, horizontalAlign: c, backgroundColor: d, maxWidth: m, maxHeight: !1 === A[z] ? q ? 4.28571429 * f : 1.5 * f : A[z], text: b, padding: da });
                        c.measureText();
                        I.push({
                            textBlock: c,
                            id: s.reversed ? E : z,
            ...
            function k(a, b) { return (b < O.length ? I[b].textBlock.y : s.reversed ? na + C : sa + C) - (0 > a ? s.reversed ? sa - C : na - C : I[a].textBlock.y + I[a].height + da) }

            function m(a, b, c) {
                var d, e, g, l = [],
                    k = C,
                    n = []; - 1 !== b && (0 <= Y.indexOf(b) ? (e = Y.indexOf(b), Y.splice(e, 1)) : (Y.push(b), Y = Y.sort(function(a, b) { return a - b })));
                if (0 === Y.length) l = ga;
                else {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                if (0 != s.length && (s.dataPoints && s.visible) && 0 !== x.length) {
                    ...
                    if (-1 !== P) {
                        ...
                        if (H && s.visible && (b(), f(), e(), "inside" !== s.indexLabelPlacement)) { l(); for (G = 0; G < x.length; G++) I[G].isDirty || (a = I[G].textBlock.x + I[G].width, a = (J - a) / 2, 0 == G && (B = a), B > a && (B = a)); for (G = 0; G < O.length; G++) O[G].x1 += B, O[G].x2 += B, O[G].x3 += B, O[G].x4 += B, O[G].x5 && (O[G].x5 += B, O[G].x6 += B), I[G].textBlock.x += B }
                        ...
                        if (!H)
                            for (G = 0; G < x.length; G++) B = s.dataPointIds[G], a = { id: B, objectType: "dataPoint", dataPointIndex: G, dataSeriesIndex: 0, funnelSection: O[s.reversed ? x.length - 1 - G : G] }, y._eventManager.objectMap[B] = a;
        ...
        F.prototype.setLayout = function() {
                ...
                if (n.dataPoints && n.dataPoints.length)
                    if ("pie" !== n.type && "doughnut" !== n.type && "funnel" !== n.type && "pyramid" !== n.type) {
                        var q = n.legendMarkerType = n.legendMarkerType ? n.legendMarkerType : "line" !== n.type && "stepLine" !== n.type && "spline" !== n.type && "scatter" !== n.type && "bubble" !== n.type || !n.markerType ? "error" === n.type && n._linkedSeries ? n._linkedSeries.legendMarkerType ?
                            n._linkedSeries.legendMarkerType : H.getDefaultLegendMarker(n._linkedSeries.type) : H.getDefaultLegendMarker(n.type) : n.markerType,
                            ...
                            w = n.markerSize || "line" !== n.type && "stepLine" !== n.type && "spline" !==
                        ...
                        for (var x = 0; x < n.dataPoints.length; x++) {
                            var y = n.dataPoints[x],
                                ...
                                g = y.legendText ? y.legendText : n.legendText ? n.legendText : this.itemTextFormatter ? this.itemTextFormatter({ chart: this.chart, legend: this.options, dataSeries: n, dataPoint: y }) : y.name ? y.name : "DataPoint: " + (x + 1),
                                v = y.legendMarkerColor ? y.legendMarkerColor : n.legendMarkerColor ? n.legendMarkerColor : y.color ?
                                y.color : n.color ? n.color : n._colorSet[x % n._colorSet.length],
                ...
                for (p = 0; p < m.length; p++) {
                    ...
                    if (!(0 >= l || "undefined" === typeof l || 0 >= u || "undefined" === typeof u)) {
                        if ("horizontal" === this.orientation) {
                            ...
                            if (!n || n.width + Math.round(q.textBlock.width + w + k + (0 === n.width ? 0 : this.horizontalSpacing) + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0)) > f) n = { items: [], width: 0 }, h.push(n), this.height += g, g = 0;
            ...
            this.items = m;
            for (p = 0; p < this.items.length; p++) q = m[p], q.id = ++this.chart._eventManager.lastObjectId, this.chart._eventManager.objectMap[q.id] = { id: q.id, objectType: "legendItem", legendItemIndex: p, dataSeriesIndex: q.dataSeriesIndex, dataPointIndex: q.dataPointIndex };
            this.markerSize = w;
            this.rows = h;
                ...
                if (0 <= f && f < this.dataPoints.length) {
                    ...
                    if (q) {
                        switch (this.type) {
                            ...
                            case "error":
                                a >=
                                    q.x1 && (a <= q.x2 && d >= q.y1 && d <= q.y2) && (b.push({ dataPoint: g, dataPointIndex: f, dataSeries: this, distance: Math.min(Math.abs(q.x1 - a), Math.abs(q.x2 - a), Math.abs(q.y1 - d), Math.abs(q.y2 - d)) }), k = !0);
                                break;
                            case "line":
                            case "stepLine":
                            case "spline":
                            ...
                            case "boxAndWhisker":
                                if (a >=
                                    q.x1 - q.borderThickness / 2 && a <= q.x2 + q.borderThickness / 2 && d >= q.y4 - q.borderThickness / 2 && d <= q.y1 + q.borderThickness / 2 || Math.abs(q.x2 - a + q.x1 - a) < q.borderThickness && d >= q.y1 && d <= q.y4) b.push({ dataPoint: g, dataPointIndex: f, dataSeries: this, distance: Math.min(Math.abs(q.x1 - a), Math.abs(q.x2 - a), Math.abs(q.y2 - d), Math.abs(q.y3 - d)) }), k = !0;
                                break;
                            case "candlestick":
                                if (a >= q.x1 - q.borderThickness / 2 && a <= q.x2 + q.borderThickness / 2 && d >= q.y2 - q.borderThickness / 2 && d <= q.y3 + q.borderThickness / 2 || Math.abs(q.x2 - a + q.x1 - a) < q.borderThickness &&
                                    d >= q.y1 && d <= q.y4) b.push({ dataPoint: g, dataPointIndex: f, dataSeries: this, distance: Math.min(Math.abs(q.x1 - a), Math.abs(q.x2 - a), Math.abs(q.y2 - d), Math.abs(q.y3 - d)) }), k = !0;
                                break;
                            case "ohlc":
        ...
        D.prototype.createLabels = function() {
            ...
            if ("axisX" !== this.type || "dateTime" !== this.valueType || this.logarithmic) {
                ...
                if (this.logarithmic && !this.equidistantInterval)
                    for (this.logLabelValues || (this.logLabelValues = [], this.createExtraLabelsForLog()), b = 0, g = q; b < this.logLabelValues.length; b++)
                        if (c =
                            ...
                            p = c;
                            a || (a = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.options, value: p, label: this.labels[p] ? this.labels[p] : null }) : "axisX" === this.type && this.labels[p] ? this.labels[p] : ea(p, this.valueFormatString, this.chart._cultureInfo), a = new ia(this.ctx, {
                                x: 0,
                                y: 0,
                                maxWidth: f,
                                maxHeight: l,
                ...
                for (this.intervalStartPosition =
                    ...
                    a || (a = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.options, value: new Date(p), label: this.labels[p] ? this.labels[p] : null }) : "axisX" === this.type && this.labels[p] ?
        ...
        D.prototype.renderLabelsTicksAndTitle = function() {
            ...
            f =
                0;
            if ("inside" === this.labelPlacement) this.chart.addEventListener("dataAnimationEnd", function() { for (h = 0; h < a._labels.length; h++) n = a._labels[h], n.position < a.viewportMinimum || (n.position > a.viewportMaximum || d && 0 !== f++ % 2 && a.labelAutoFit) || (a.ctx.save(), a.ctx.beginPath(), n.textBlock.render(!0), a.ctx.restore()) }, this);
            else
            ...
            if (0 !== this.spacing ||
                ...
                if ("bottom" === this.scaleBreaks.parent._position || "top" === this.scaleBreaks.parent._position)
                    if (b = 1 === n % 2 ? (b.x << 0) + 0.5 : b.x << 0, l = 1 === n % 2 ? (e.x << 0) + 0.5 : e.x << 0, "top" === this.scaleBreaks.parent._position ? (e = this.chart.plotArea.y1, k = this.chart.plotArea.y2 +
                            n / 2 + 0.5 << 0) : (e = this.chart.plotArea.y2, k = this.chart.plotArea.y1 - n / 2 + 0.5 << 0, a *= -1), this.bounds = { x1: b - n / 2, y1: e, x2: l + n / 2, y2: k }, this.ctx.moveTo(b, e), "straight" === this.type || "top" === this.scaleBreaks.parent._position && 0 >= a || "bottom" === this.scaleBreaks.parent._position && 0 <= a) this.ctx.lineTo(b, k), this.ctx.lineTo(l, k), this.ctx.lineTo(l, e);
                    ...
                    if (e = 1 === n % 2 ? (e.y << 0) + 0.5 : e.y <<
                        0, k = 1 === n % 2 ? (b.y << 0) + 0.5 : b.y << 0, "left" === this.scaleBreaks.parent._position ? (b = this.chart.plotArea.x1, l = this.chart.plotArea.x2 + n / 2 + 0.5 << 0) : (b = this.chart.plotArea.x2, l = this.chart.plotArea.x1 - n / 2 + 0.5 << 0, a *= -1), this.bounds = { x1: b, y1: e - n / 2, x2: l, y2: k + n / 2 }, this.ctx.moveTo(b, e), "straight" === this.type || "left" === this.scaleBreaks.parent._position && 0 >= a || "right" === this.scaleBreaks.parent._position && 0 <= a) this.ctx.lineTo(l, e), this.ctx.lineTo(l, k), this.ctx.lineTo(b, k);
                    else if ("wavy" === this.type) {
                    m = b;
                    h = e;
                    f = 0.5;
        ...
        M.prototype.render = function() {
            ...
            if (0 < d) {
                ...
                if ("bottom" === this.parent._position || "top" === this.parent._position) e = f = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0, k = this.chart.plotArea.y1, m = this.chart.plotArea.y2, this.bounds = { x1: e - d / 2, y1: k, x2: f + d / 2, y2: m };
        ...
        $.prototype.render = function(a, d, c) {
            ...
            if (this.snapToDataPoint) {
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    ...
                    p.sort(function(a, b) { return a.distance - b.distance });
                    ...
                    if ("bottom" === this.parent._position || "top" === this.parent._position) {
                        ...
                        if ("rangeBar" === this.parent.dataSeries[y].type || "error" === this.parent.dataSeries[y].type) {
                            ...
                            h.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: c ? c : x.dataPoint.y[b] }) : r(this.options.label) ? ea(c ? c : x.dataPoint.y[b], this.valueFormatString, this.chart._cultureInfo) :
                                this.label
                            ...
                            this.value = E;
                            h.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: c ? c : x.dataPoint.y }) : r(this.options.label) ?
                            ...
                            m = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(C) << 0) + 0.5 : this.parent.convertValueToPixel(C) <<
                                0;
                            this.value = C;
                            h.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: c ? c : C }) : r(this.options.label) ? ea(c ? c : C, this.valueFormatString, this.chart._cultureInfo) : this.label
                        ...
                        if (C) {
                            if ("axisX" === this.parent.type)
                                for (v = this.parent.convertPixelToValue({ y: d }), u = null, y = 0; y < this.parent.dataSeries.length; y++)(u = this.parent.dataSeries[y].getDataPointAtX(v, !0)) && 0 <= u.index && (h.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: x.dataPoint.x }) : r(this.options.label) ? u.dataPoint.label : this.label)
                        } else "dateTime" === this.parent.valueType ? h.text = this.labelFormatter ? this.labelFormatter({
                            chart: this.chart,
                            axis: this.parent.options,
                            crosshair: this.options,
                            value: c ? c : x.dataPoint.x
                        }) : r(this.options.label) ? Aa(c ? c : x.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label : "number" === this.parent.valueType && (h.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: c ? c : x.dataPoint.x }) : r(this.options.label) ? ea(c ? c : x.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label);
                    ...
                    if (C) {
                        if ("axisX" === this.parent.type)
                            for (v = this.parent.convertPixelToValue({ x: a }), u = null, y = 0; y < this.parent.dataSeries.length; y++)(u = this.parent.dataSeries[y].getDataPointAtX(v, !0)) && 0 <= u.index && (h.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: x.dataPoint.x }) : r(this.options.label) ? u.dataPoint.label : this.label)
                    ...
                    if ("rangeColumn" === this.parent.dataSeries[y].type || "rangeArea" === this.parent.dataSeries[y].type || "error" === this.parent.dataSeries[y].type || "rangeSplineArea" === this.parent.dataSeries[y].type || "candlestick" === this.parent.dataSeries[y].type || "ohlc" === this.parent.dataSeries[y].type || "boxAndWhisker" === this.parent.dataSeries[y].type) {
                        ...
                        h.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: c ? c : x.dataPoint.y[b] }) : r(this.options.label) ? ea(c ? c : x.dataPoint.y[b], this.valueFormatString,
                ...
                if ("bottom" === this.parent._position || "top" === this.parent._position) b = e = m = 1 === q.lineWidth % 2 ? (a << 0) + 0.5 : a << 0, f = this.chart.plotArea.y1, k = this.chart.plotArea.y2, this.bounds = { x1: b - n / 2, y1: f, x2: e + n / 2, y2: k };
                else if ("left" === this.parent._position || "right" === this.parent._position) f = k = w = 1 === q.lineWidth %
                    2 ? (d << 0) + 0.5 : d << 0, b = this.chart.plotArea.x1, e = this.chart.plotArea.x2, this.bounds = { x1: b, y1: f - n / 2, x2: e, y2: k + n / 2 };
                if ("xySwapped" === this.chart.plotInfo.axisPlacement)
                    if ("left" === this.parent._position || "right" === this.parent._position) {
                        ...
                        if (C) {
                            if ("axisX" === this.parent.type)
                                for (v = this.parent.convertPixelToValue({ y: d }), u = null, y = 0; y < this.parent.dataSeries.length; y++)(u =
                            ...
                            c : this.parent.convertPixelToValue(d), this.valueFormatString, this.chart._cultureInfo) : this.label : "number" === this.parent.valueType && (h.text = this.labelFormatter ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: c ? c : this.parent.convertPixelToValue(d) }) : r(this.options.label) ? ea(c ? c : this.parent.convertPixelToValue(d), this.valueFormatString, this.chart._cultureInfo) : this.label);
                    ...
                    if (C) {
                        if ("axisX" === this.parent.type)
                            for (v = this.parent.convertPixelToValue({ x: a }), u = null, y = 0; y < this.parent.dataSeries.length; y++)(u = this.parent.dataSeries[y].getDataPointAtX(v, !0)) && 0 <= u.index && (h.text = this.labelFormatter ? this.labelFormatter({
                                chart: this.chart,
                                axis: this.parent.options,
                                crosshair: this.options,
                                value: c ? c : this.parent.convertPixelToValue(a)
                    ...
                    if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                        ...
                        if (this.chart.axisX)
                            for (var u = 0; u < this.chart.axisX.length; u++) {
                                for (var k = this.chart.axisX[u].convertPixelToValue({ y: d }), h = null, b = 0; b < this.chart.axisX[u].dataSeries.length; b++)(h = this.chart.axisX[u].dataSeries[b].getDataPointAtX(k, c)) && 0 <= h.index && (h.dataSeries = this.chart.axisX[u].dataSeries[b], null !== h.dataPoint.y && m.push(h));
                                h = null
                            }
                        if (this.chart.axisX2)
                            for (u = 0; u < this.chart.axisX2.length; u++) {
                                k =
                                    this.chart.axisX2[u].convertPixelToValue({ y: d });
                                h = null;
                        ...
                        if (this.chart.axisX)
                            for (u = 0; u < this.chart.axisX.length; u++)
                                for (k = this.chart.axisX[u].convertPixelToValue({ x: a }), h = null, b = 0; b < this.chart.axisX[u].dataSeries.length; b++)(h = this.chart.axisX[u].dataSeries[b].getDataPointAtX(k,
                                    c)) && 0 <= h.index && (h.dataSeries = this.chart.axisX[u].dataSeries[b], null !== h.dataPoint.y && m.push(h));
                        if (this.chart.axisX2)
                            for (u = 0; u < this.chart.axisX2.length; u++)
                                for (k = this.chart.axisX2[u].convertPixelToValue({ x: a }), h = null, b = 0; b < this.chart.axisX2[u].dataSeries.length; b++)(h = this.chart.axisX2[u].dataSeries[b].getDataPointAtX(k, c)) && 0 <= h.index && (h.dataSeries = this.chart.axisX2[u].dataSeries[b], null !== h.dataPoint.y && m.push(h))
                    }
