...
$mariadb = new MariaDB;
$dbaccount=$mariadb->getAll($domain);
?>
<!-- Start of Wrapper  -->
   <div class="wrapper">
                    ...
                    <div class="rcontent">
                        ...
                        <div class="col-sm-10 mt-3">
                            <ul class="nav nav-tabs" role="tablist">
                              <li class="nav-item">
                                <a href="/admin/share_setting/servers/database?id=<?=$id?>" class="nav-link links btn btn-outline-primary" role="tab">MYSQL</a>
                              </li>
                              <li class="nav-item">
                                <a href="/admin/share_setting/servers/database/mssql?id=<?=$id?>" class="nav-link links btn btn-outline-primary" role="tab">MSSQL</a>
                              </li>
                              <li class="nav-item">
                                <a href="/admin/share_setting/servers/database/mariadb?id=<?=$id?>" class="nav-link links btn btn-outline-primary active" role="tab">MARIADB</a>
                              </li>
                            </ul>
                                    ...
                                    <table class="table table-borderless">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="javascript:;" data-toggle="modal" data-target="#common_modal" class="btn btn-warning btn-sm edit_database common_modal"  gourl="/share/servers/database/edit" edit_id="<?php echo $db['id']; ?>" db="MARIADB"><i class="fas fa-edit text-white"></i></a>
                                                    <a href="javascript:;"  data-toggle="modal" data-target="#common_modal_delete" class="btn btn-danger btn-sm edit_database common_modal_delete"  gourl="/share/servers/database/delete" delete_id="<?php echo $db['id']; ?>" db="MARIADB"><i class="fas fa-trash text-white"></i></a>
                                                </td>
                                                <td>情報</td>
                                            </tr>
                                            <?php
