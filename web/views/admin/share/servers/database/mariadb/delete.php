...
$act_id = $_GET['act_id'];
$query = "select * from db_account_mariadb where domain='$webdomain' and id='$act_id'";
...
<div class="modal-body">
  ...
  <form action="/admin/share/servers/database?confirm&webid=<?=$webid?>&db=mariadb" method="post" id="delete_database">
