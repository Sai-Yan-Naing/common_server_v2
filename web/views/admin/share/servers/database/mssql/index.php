                ...
                <div class="col-sm-9">
                    ...
                    <div class="rcontent">
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <button class="btn btn-success btn-sm common_modal" type="button" data-toggle="modal" data-target="#common_modal" gourl="/admin/share/servers/database?webid=<?=$webid?>&act=new&db=mssql"><span class="add-db-icon"><i class="fas fa-plus"></i></span>データベース追加</button>
                            </div>
                        </div>
                        <div class="d-flex">
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                              ...
                              <li class="nav-item">
                                <a href="/admin/share/servers/database?webid=<?=$webid?>&db=mssql" class="nav-link links btn btn-outline-primary active" role="tab">MSSQL</a>
                              </li>
                              <li class="nav-item">
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a data-toggle="modal" data-target="#common_modal" class="btn btn-warning btn-sm common_dialog"  gourl="/admin/share/servers/database?webid=<?=$webid;?>&act=edit&db=mssql&act_id=<?=$db['id']?>" edit_id="<?php echo $db['id']; ?>"><i class="fas fa-edit text-white"></i></a>
                                                    <a  data-toggle="modal" data-target="#common_modal" class="btn btn-danger btn-sm edit_database common_dialog"  gourl="/admin/share/servers/database?webid=<?=$webid?>&act=delete&db=mssql&act_id=<?=$db['id']?>" delete_id="<?php echo $db['id']; ?>" db="MYSQL"><i class="fas fa-trash text-white"></i></a>
                                                </td>
                                                <td>情報</td>
                                            </tr>
                                            <?php
