                ...
                <div class="col-sm-9">
                    ...
                    <div class="rcontent">
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <button class="btn btn-success btn-sm common_modal" type="button" data-toggle="modal" data-target="#common_modal" gourl="/admin/share/servers/database?webid=<?=$webid?>&act=new&db=mysql"><span class="add-db-icon"><i class="fas fa-plus"></i></span>データベース追加</button>
                            </div>
                        </div>
                        <div class="d-flex">
                        ...
                        <div class="col-sm-10 mt-3">
                            <ul class="nav nav-tabs" role="tablist">
                              <li class="nav-item">
                                <a href="/admin/share/servers/database?webid=<?=$webid?>&db=mysql" class="nav-link links btn btn-outline-primary active" role="tab">MYSQL</a>
                              </li>
                              <li class="nav-item">
                                <a href="/admin/share/servers/database?webid=<?=$webid?>&db=mssql" class="nav-link links btn btn-outline-primary" role="tab">MSSQL</a>
                              </li>
                              <li class="nav-item">
                                <a href="/admin/share/servers/database?webid=<?=$webid?>&db=mariadb" class="nav-link links btn btn-outline-primary" role="tab">MARIADB</a>
                              </li>
                            </ul>
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="javascript:;" data-toggle="modal" data-target="#common_modal" class="btn btn-warning btn-sm common_dialog"  gourl="/admin/share/servers/database?webid=<?=$webid;?>&act=edit&db=mysql&act_id=<?=$db['id']?>" edit_id="<?php echo $db['id']; ?>" db="MYSQL"><i class="fas fa-edit text-white"></i></a>
                                                    <a href="javascript:;"  data-toggle="modal" data-target="#common_modal" class="btn btn-danger btn-sm edit_database common_dialog"  gourl="/admin/share/servers/database?webid=<?=$webid?>&act=delete&db=mysql&act_id=<?=$db['id']?>" delete_id="<?php echo $db['id']; ?>" db="MYSQL"><i class="fas fa-trash text-white"></i></a>
                                                </td>
                                                <td>情報</td>
                                            </tr>
                                            <?php
