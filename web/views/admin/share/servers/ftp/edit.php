...
<div class="modal-body">
  ...
  <form action="/admin/share/servers/ftp?confirm&webid=<?=$webid?>" method="post" id="ftp_create">
    <input type="hidden" name="action" value="edit">
    <input type="hidden" name="act_id" value="<?= $getRow['id'] ?>">
      <div class="form-group row">
          <label for="ftp_user" class="col-sm-4 col-form-label">FTPユーザー</label>
          <div class="col-sm-8">
            <input type="text" class="form-control" readonly value="<?= $getRow['ftp_user'] ?>" name="ftp_user" placeholder="1-14文字、半角英数字">
          </div>
      </div>
      <div class="form-group row">
