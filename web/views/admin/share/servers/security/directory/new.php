...
<div class="modal-body">
    <form action="/admin/share/servers/security/directory?confirm&webid=<?=$webid?>" method="post" id="dir_path_create">
      ...
      <div class="row justify-content-center">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" column="ftp_user" id="ftp_user" name="ftp_user" placeholder="1-14文字、半角英数字"><i class="fas fa-folder text-warning fa-lg" style="font-size: 2.33em; display:none;"></i>
          </div>
      </div>
      <div class="row justify-content-center">
...
<div class="modal-footer  d-flex justify-content-center">
  ...
  <button type="submit" class="btn btn-success btn-sm" form="dir_path_create">作成</button>
</div>