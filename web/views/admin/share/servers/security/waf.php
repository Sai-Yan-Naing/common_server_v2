                    ...
                    <div class="tab-content">
                        <div id="waf" class="pr-3 pl-3 tab-pane active"><br>
                            ...
                            <div class="form-group row">
                                ...
                                <input type="checkbox" data-toggle="toggle" data-onstyle="success" data-offstyle="danger" data-on="ON" data-off="OFF" data-size="normal" <?php if($waf['usage']==1){echo "checked";} ?> onchange="this.form.submit()" name="onoff" form="usage-onoff">
                            </div>
                            <div class="form-group row">
