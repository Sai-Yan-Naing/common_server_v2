            ...
            <div class="row">
                ...
                <div class="col-sm-9">
                    ...
                    <ul class="nav nav-tabs">
                        ...
                        <li class="nav-item">
                            <a href="/admin/share/servers/sites/basic?webid=<?=$webid?>" class="nav-link active">基本設定</a>
                        </li>
                        <li class="nav-item">
                            ...
                            <div id="accordion">
                                ...
                                <div class="card">
                                    ...
                                    <div class="mb-2">認証ユーザー</div>
                                        ...
                                        <button class="btn btn-success btn-sm common_dialog" type="button" data-toggle="modal" data-target="#common_modal" gourl="/admin/share/servers/sites/basic?act=new&dir_id=<?=$main_key?>&webid=<?=$webid?>"><span class="add-db-icon"><i class="fas fa-plus"></i></span>User追加</button>
                                    </div>
                                    </div>
                                </div>
                                <?php } ?>
