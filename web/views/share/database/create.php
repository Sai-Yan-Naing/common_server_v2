...
<div class="modal-body">
    <form action="/share/servers/database/confirm" method="post" id="database_create">
      <input type="hidden" name="action" value="new">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-8">
              ...
              <label for="db_name" id="db_name_exerror" class="error"></label>
            </div>
        </div>
        <div class="form-group row">
            ...
            <div class="col-sm-8">
              ...
              <label for="db_user" id="db_user_error" class="error"></label>
              <label for="db_user" id="db_user_exerror" class="error"></label>
            </div>
        </div>
        <div class="form-group row">
