                    ...
                    <div class="rcontent">
                        ...
                        <div class="col-sm-10 mt-3">
                            <ul class="nav nav-tabs" role="tablist">
                              ...
                              <li class="nav-item">
                                <a href="/share/servers/database/mssql" class="nav-link links btn btn-outline-primary" role="tab">MSSQL</a>
                              </li>
                              <li class="nav-item">
                                <a href="/share/servers/database/mariadb" class="nav-link links btn btn-outline-primary active" role="tab">MARIADB</a>
                              </li>
                            </ul>
