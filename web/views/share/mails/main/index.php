                ...
                <div class="col-sm-9">
                    ...
                    <div class="rcontent">
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <button class="btn btn-success btn-sm common_modal" type="button" data-toggle="modal" data-target="#common_modal" gourl="/share/mails?act=new&webid=<?=$webid?>"><span class="add-db-icon"><i class="fas fa-plus"></i></span>メールアドレス追加</button>
                            </div>
                        </div>
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $mail['password'] ?></td>
                                        <td>
                                            <a href="javascript:;" data-toggle="modal" data-target="#common_modal" class="btn btn-warning btn-sm common_dialog"  gourl="/share/mails?act=edit&webid=<?=$webid?>&act_id=<?=$mail['id']?>"><i class="fas fa-edit text-white"></i></a>
                                            <a href="javascript:;"  data-toggle="modal" data-target="#common_modal" class="btn btn-danger btn-sm common_dialog"  gourl="/share/mails?act=delete&webid=<?=$webid?>&act_id=<?= $mail['id']?>"><i class="fas fa-trash text-white"></i></a>
                                        </td>
                                    </tr>
                                    <?php
                                        }
