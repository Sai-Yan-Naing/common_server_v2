...
<div class="modal-body">
    <form action="/share/servers/database?confirm&webid=<?=$webid?>&db=mysql" method="post" id="database_create">
      <input type="hidden" name="action" value="new">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" id="db_name" name="db_name" placeholder="8～70文字、半角英数記号の組み合わせ" column="db_name" table="db_account" remark="mydbname">
            </div>
        </div>
        <div class="form-group row">
