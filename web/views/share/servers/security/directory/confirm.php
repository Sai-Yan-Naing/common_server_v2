...
if(!isset($_POST['action']) || !isset($_POST['ftp_user'])){ header("location: /share/servers/security/directory?webid=$webid"); die();}
...
if(isset($_POST['action']) and $_POST['action']=='new')
{
	...
	if(!$commons->doThis($insert_q))
	{
		...
		require_once('views/share/servers/security/directory.php');
		die();
	}
...
header("location: /share/servers/security/directory?webid=$webid");
