                    ...
                    <div class="tab-content">
                        <div id="ip-restriction" class=" pr-3 pl-3 pb-3 tab-pane active"><br>
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <button class="btn btn-success btn-sm common_dialog" type="button" data-toggle="modal" data-target="#common_modal" gourl="/share/servers/security/directory?act=new&webid=<?=$webid?>"><span class="add-db-icon"><i class="fas fa-plus"></i></span>ディレクトリ追加</button>
                                </div>
                            </div>
                            <div class="mt-4">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                          <tr>
                                             ...
                                             <td><?=$value['path']?></td>
                                             <td>
                                                <button gourl="/share/servers/security/directory?act=edit&act_id=<?=$value['id']?>&webid=<?=$webid?>" class="pr-2 btn btn-warning btn-sm common_dialog" data-toggle="modal" data-target="#common_modal"><i class="fas fa-edit text-white"></i></button>
                                                <button class="pr-2 btn btn-danger btn-sm common_dialog" data-toggle="modal" data-target="#common_modal" gourl="/share/servers/security/directory?act=delete&act_id=<?=$value['id']?>&webid=<?=$webid?>"><i class="fas fa-trash text-white"></i></button>
                                            </td> 
                                          </tr>
                                          <?php
                                            }
