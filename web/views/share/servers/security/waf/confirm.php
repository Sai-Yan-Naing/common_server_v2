...
// die('hello');
if(!isset($_POST['switch'])){header("location: /share/servers/security/waf?webid=$webid");}
...
if($switch=='usage')
{
	...
	if(!$commons->doThis($usage_query))
	{
		...
		require_once ("views/share/servers/security/waf.php");
		// header("location: /share/servers/security/waf?webid=$webid");
	}
}else{
