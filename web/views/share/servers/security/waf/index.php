            ...
            <div class="row">
                ...
                <div class="col-sm-9">
                    ...
                    <ul class="nav nav-tabs">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="/share/servers/security/waf?webid=<?=$webid?>">WAF</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/share/servers/security/directory?webid=<?=$webid?>">ディレクトリアクセス</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/share/servers/security/ip?webid=<?=$webid?>">IPアクセス制限</a>
                        </li>
                    </ul>
                    ...
                    <div class="tab-content">
                        <div id="waf" class="pr-3 pl-3 tab-pane active"><br>
                            ...
                            <form action="/share/servers/security/waf?confirm&webid=<?=$webid?>" method ="post" id="usage-onoff">
                                <input type="hidden" name="switch" value="usage">
                            </form>
                            <form action="/share/servers/security/waf?confirm&webid=<?=$webid?>" method ="post" id="display-onoff">
