...
<div class="col-sm-3">
    ...
    <div class="p-3 <?php if($url[2]=='servers' && $url[3]=='database'){echo 'active hovar-color';} ?>"><a class="menu" href="/share/servers/database?db=mysql"><span class="icon"><i class="fas fa-database"></i></span><span class="pl-2">データベース</span></a></div>
