                ...
                <div class="col-sm-9">
                    ...
                    <div class="rcontent">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <form action="/share/various/backup?confirm&webid=<?=$webid?>" method = "post">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-sm-5">
                                <button class="btn btn-success btn-sm common_dialog" type="button" data-toggle="modal" data-target="#common_modal" gourl="/share/various/backup?act=new&webid=<?=$webid?>"><span class="add-db-icon"><i class="fas fa-plus"></i></span>バックアップを実施</button>
                            </div>
                        </div>
                        <div id="changeBackup">
                        <?php
                            ...
                            <table class="table mt-3 table-bordered">
                                ...
                                <tbody>
                                  <tr>
                                    ...
                                    <td>
                                        <button data-toggle="modal" data-target="#common_modal" class="btn btn-warning btn-sm common_dialog"  gourl="/share/various/backup?act=restore&webid=<?=$webid?>">リストア</button>
                                        <button  data-toggle="modal" data-target="#common_modal" class="btn btn-danger btn-sm common_dialog"  gourl="/share/various/backup?act=delete&webid=<?=$webid?>"><i class="fas fa-trash text-white"></i></button>
                                    </td>
                                  </tr>
                                </tbody>
                            </table>
