<div class="col-sm-3">
    ...
    <div   class="p-3 <?php if(strpos($url[2],'various') !==false && $url[3] ==''){echo 'active hovar-color';} ?>"><a href="/share/various"><span>ご契約情報</span></a></div>
    <!-- <div   class="p-3 <?php if($url[2]=='various'&& $url[3] =='domain'){echo 'active hovar-color';} ?>"><a href="/share/various/domain"><span >ドメイン</span></a></div> -->
    <div   class="p-3 <?php if($url[2]=='various' && strpos($url[3],'backup') !==false){echo 'active hovar-color';} ?>"><a href="/share/various/backup"><span>自動バックアップ</span></a></div>
</div>